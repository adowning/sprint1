...
public class ApplicationStarter extends Application {
    public void onCreate() {
        super.onCreate();
        Log.d("adsf", "xxxxxxxxxxxxxxxxxxxxxxxxxxx");
//        WLClient.createInstance(ApplicationStarter.this);
    }
//
//    @Override
//    public void onCreate() {
...
//        ParseUser.logInInBackground("cooldude6", "asdf", new LogInCallback() {
