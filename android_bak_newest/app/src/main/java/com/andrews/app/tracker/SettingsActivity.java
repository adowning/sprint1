...
public class SettingsActivity extends PreferenceActivity {
    ...
    public static class MyPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(final Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            ;
            prefUsername.setDefaultValue("asdf");
            prefUsername.setDefaultValue("asdf");
            prefLiveSync.setDefaultValue(true);
            prefPass.setDefaultValue("asdf");
            prefHost.setDefaultValue("http://localhost:1337");
    ...
    private final static Preference.OnPreferenceClickListener serverSetupClicked = new Preference.OnPreferenceClickListener() {
        ...
        public boolean onPreferenceClick(Preference preference) {
            ...
            if (db.getTrackId() > 0) {
                ...
                Alert.showInfo(context,"server setup changed", "asdf");
            return true;
        }
        return true;
    };
