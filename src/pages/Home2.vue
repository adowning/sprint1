<template>
  <div class="home page">
    ...
    <UiInputText v-model="msg" placeholder="Enter message" label="Enter message" someHelloProp="hello" @blur="onBlur" @keyup.enter="onEnter" @keyup.esc="onEsc" :error="inputError">
      <div slot="before">
